 ...
 */
@Getter
public class MsBadRequestException extends RuntimeException {

    /** Serial. */
    @Serial
    private static final long serialVersionUID = -4261009918545217405L;
    /** Código de error. */
     ...
     */
    public MsBadRequestException(final String message, final String code) {
        super(message);
        this.code = code;
     ...
     */
    public MsBadRequestException(Message message) {
